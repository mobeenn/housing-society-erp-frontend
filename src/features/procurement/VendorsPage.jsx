    ...
    },
    {
      ...
      render: (row) => (
        <div className="text-sm">
          ...
          <div className="text-xs text-gray-500">{row.phone || row.email || "No contact info"}</div>
        </div>
      ),
    },
    {
      key: "paymentTerms",
      label: "Payment Terms",
      render: (row) => <span className="text-gray-600 text-sm">{row.paymentTerms || "Net 30"}</span>,
    },
    {
      key: "status",
      label: "Status",
      ...
      render: (row) => (
        <span
          className={`font-mono text-sm font-medium ${
            (row.outstandingBalance || 0) > 0 ? "text-red-600" : "text-gray-700"
          }`}
        >
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto" data-tour="procurement-page">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2" data-tour="procurement-heading">
      ...
      {/* Filters Bar */}
      <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm mb-6 flex flex-wrap gap-4 items-center" data-tour="procurement-filters">
        <div>
          ...
          <div className="bg-white rounded-xl max-w-3xl w-full p-6 shadow-xl relative max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b pb-3 mb-4">
              <div>
                ...
                <span className="text-xs text-gray-500">Category: {detailVendor.category}</span>
              </div>
              <button
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-gray-50 p-4 rounded-lg mb-6 border">
              <div>
              ...
              <div>
                <div className="text-xs text-gray-500">NTN / Tax ID</div>
                <div className="text-sm font-medium text-gray-800 mt-1">
            ...
            <div className="mb-6">
              ...
              <div className="bg-white border rounded-lg p-3 grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                <div>
                  <span className="text-xs text-gray-500 block">Contact Person:</span>
                  <span className="font-medium text-gray-900">{detailVendor.contactPerson || "—"}</span>
                </div>
                <div>
                  <span className="text-xs text-gray-500 block">Phone:</span>
                  <span className="font-medium text-gray-900">{detailVendor.phone || "—"}</span>
                </div>
                <div>
                ...
                <div className="md:col-span-3">
                  ...
                  <span className="font-medium text-gray-900">{detailVendor.address || "—"}</span>
                </div>
              </div>
            </div>
            ...
            {detailVendor.performanceNotes && (
              <div className="mb-6">
                <h3 className="text-sm font-semibold text-gray-800 uppercase tracking-wider mb-2 flex items-center gap-1.5">
            ...
            <div>
              ...
              {historyLoading ? (
                <div className="text-center py-6 text-gray-500 text-sm">Loading purchase history...</div>
                    ...
                    <tbody className="divide-y">
                      {purchaseHistory.purchaseOrders.map((po) => (
                        <tr key={po._id} className="hover:bg-gray-50">
                          <td className="px-4 py-2.5 font-mono text-blue-600 font-medium">{po.poNumber}</td>
